...
# Identical to the script run_experiment, but for the bandit instance inferred from MOvieLens
# Result path variable
OUT_FILE_PATH="results/_run_logs/full_cost_subsidy/movie_lens/"
# Hardcoded list of files using the common path variable
FILES=(
    "data/ml-25m/bandit_instance.txt"
)
