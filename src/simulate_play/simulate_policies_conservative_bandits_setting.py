import numpy as np
from src.utils import simulate_bandit_rewards
import sys
import argparse
...
if __name__ == '__main__':
    ...
    # Print a column headers for the output file, margin is the margin on the constraint
    sys.stdout.write("algo,rs,time-step,reg,marginnsamps\n")
    for al in algos:
