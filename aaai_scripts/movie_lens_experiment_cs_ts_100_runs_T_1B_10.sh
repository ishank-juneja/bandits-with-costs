...
for file in "${FILES[@]}"; do
    ...
    logname="${filename%.*}_cs_ts_100_runs_1B_10_log.csv"

    python3 src/simulate_play/simulate_ts_cs_91_100.py -file "$file" -STEP $STEP -horizon $HORIZON > "${OUT_FILE_PATH}${logname}"
done
