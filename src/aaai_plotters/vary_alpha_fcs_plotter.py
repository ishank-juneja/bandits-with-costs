...
assert num_files1 == 9, "Number of files in Linear Cost Regret experiment should be 12"
...
plot1_xs_markers = np.linspace(0.05, 0.45, 9) # The value of the varying first arm for the instance family
...
axs.set_title(r'Goodreads varying $\alpha$', fontsize=18, fontweight='bold', pad=10)
...
# Save figure
plt.savefig(save_dir + "/fig2d.pdf", bbox_inches="tight")
plt.close()
